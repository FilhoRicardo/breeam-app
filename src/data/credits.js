export const CREDITS = [
  ...
  {
    code: "Hea 8", category: "Health", title: "Ventilation system air intakes and exhausts", available: 2, part: 2,
    aim: "To minimise re-entry of polluted air into the asset by ensuring ventilation intakes are sited away from external and internal sources of contamination.",
    question: "Are ventilation system air intakes and exhausts located to avoid the re-circulation of pollutants?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 2, label: "Yes — intakes and exhausts comply with separation distances and siting requirements" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Air intakes located ≥ 10 m horizontally from sources of external pollution (loading bays, vehicle exhausts, kitchen extracts, cooling tower discharges, plant exhausts).", details: [] },
      { id: 2, answer: "C", text: "Where ≥ 10 m horizontal separation cannot be achieved, intakes are located ≥ 3 m vertically above the pollution source.", details: [] },
      { id: 3, answer: "C", text: "Exhausts discharge away from openable windows, air intakes and pedestrian areas.", details: [] },
      { id: 4, answer: "C", text: "Intakes and exhausts are clearly labelled and maintained free of obstruction.", details: [] },
    ],
    methodology: [
      "Survey all mechanical intakes and exhausts; map distances and orientations on site plans.",
      "Confirm any non-compliances are mitigated by vertical offset or alternative location.",
    ],
    evidence: [
      "Site/floor plans annotated with intake and exhaust locations and separation distances",
      "Photographic evidence of intake/exhaust terminals and labelling",
    ],
    notes: [
      "Summarised from BREEAM In-Use v6 HEA 08 PDF.",
    ],
  },
  {
    code: "Hea 9", category: "Health", title: "Indoor air quality — CO₂ sensors", available: 2, part: 2,
    aim: "To recognise the installation of CO₂ sensors that monitor occupancy-driven ventilation effectiveness.",
    question: "Are CO₂ sensors installed and linked to the ventilation system in densely occupied spaces?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — CO₂ sensors installed in all relevant densely occupied spaces" },
      { id: "D", credits: 2, label: "Yes — sensors installed and linked to the ventilation system / BMS with alerts" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Densely occupied space: occupant density ≥ 1 person per 10 m² (meeting rooms, classrooms, lecture theatres, auditoria, etc.).", details: [] },
      { id: 2, answer: "C,D", text: "Sensors located in the breathing zone (1.1–1.7 m above floor), away from windows, doors and supply diffusers.", details: [] },
      { id: 3, answer: "D", text: "Sensors connected to BMS / ventilation control to modulate fresh air rate or trigger alerts when CO₂ > 1000 ppm.", details: [] },
    ],
    methodology: [
      "Identify densely occupied spaces; confirm sensor coverage and calibration record.",
    ],
    evidence: [
      "Sensor schedule and floor plans",
      "BMS screenshots / commissioning report",
    ],
    notes: ["Summarised from BREEAM In-Use v6 HEA 09 PDF."],
  },
  {
    code: "Hea 10", category: "Health", title: "Carbon monoxide detection", available: 1, part: 2,
    aim: "To protect occupants from exposure to carbon monoxide from combustion appliances or attached parking areas.",
    question: "Are CO detectors installed in all areas where combustion appliances or attached enclosed parking are present?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — CO detectors installed, tested and linked to alarm" },
      { id: "D", credits: 0, label: "Not applicable — no combustion appliances or attached enclosed parking" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "CO detectors installed in rooms containing combustion appliances and in enclosed parking attached to the building.", details: [] },
      { id: 2, answer: "C", text: "Detectors meet relevant national standard (e.g. BS EN 50291) and are tested at least annually.", details: [] },
      { id: 3, answer: "C", text: "Alarm audible in occupied areas and linked to a documented response procedure.", details: [] },
    ],
    methodology: ["Audit appliance and parking locations; verify detector placement and test logs."],
    evidence: ["Detector schedule, test logs, alarm response procedure"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 10 PDF."],
  },
  {
    code: "Hea 11", category: "Health", title: "Rest areas", available: 1, part: 2,
    aim: "To support occupant wellbeing through provision of dedicated rest areas.",
    question: "Are dedicated rest areas provided for asset users, separated from main work areas?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — compliant rest area(s) provided" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Rest area is physically separate from primary work area and free from work-related activity.", details: [] },
      { id: 2, answer: "C", text: "Provides seating, access to drinking water, natural light and ventilation where reasonably practicable.", details: [] },
      { id: 3, answer: "C", text: "Sized appropriately for peak occupancy and accessible to all asset users.", details: [] },
    ],
    methodology: ["Floor plan review; site walk to confirm provision and usability."],
    evidence: ["Photographs, floor plans showing rest area location and area"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 11 PDF."],
  },
  {
    code: "Hea 12", category: "Health", title: "Inclusive design", available: 2, part: 2,
    aim: "To recognise assets that provide inclusive and accessible facilities for all users.",
    question: "Has the asset been designed and managed in accordance with inclusive design principles?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — accessibility audit completed and findings actioned" },
      { id: "D", credits: 2, label: "Yes — inclusive design strategy in place, audit completed and improvements documented" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Accessibility audit by a qualified access consultant covering entrances, vertical circulation, WCs, signage and wayfinding.", details: [] },
      { id: 2, answer: "D", text: "Inclusive design strategy addresses neurodiversity, sensory impairments, and cultural inclusivity, and is reviewed at least every 3 years.", details: [] },
      { id: 3, answer: "C,D", text: "Findings are tracked in an action plan with owners and target dates.", details: [] },
    ],
    methodology: ["Commission audit; track actions; review against national accessibility standard."],
    evidence: ["Access audit report", "Inclusive design strategy", "Action plan with status"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 12 PDF."],
  },
  {
    code: "Hea 13", category: "Health", title: "Drinking water provision", available: 1, part: 2,
    aim: "To ensure asset users have ready access to safe drinking water.",
    question: "Is free, accessible drinking water provided throughout the asset?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — drinking water points provided within 100 m of every workstation / occupied space" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Drinking water available free of charge from a dedicated drinking water tap, fountain or chilled dispenser.", details: [] },
      { id: 2, answer: "C", text: "Locations clearly signposted and accessible to all users including those with mobility impairments.", details: [] },
      { id: 3, answer: "C", text: "Outlets are maintained on a documented schedule (cleaning, filter replacement, water quality testing).", details: [] },
    ],
    methodology: ["Map outlets on floor plans; verify maintenance log."],
    evidence: ["Floor plans showing drinking water outlets", "Maintenance schedule"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 13 PDF."],
  },
  {
    code: "Hea 14", category: "Health", title: "Thermal comfort", available: 3, part: 2,
    aim: "To deliver appropriate thermal comfort levels for asset users.",
    question: "Has thermal comfort been assessed and managed in accordance with recognised standards?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Thermal comfort survey completed in the last 3 years" },
      { id: "D", credits: 2, label: "Survey completed AND PMV / PPD analysis to ISO 7730 / EN 16798 for representative spaces" },
      { id: "E", credits: 3, label: "Survey + analysis + documented thermal comfort action plan implemented" },
    ],
    criteria: [
      { id: 1, answer: "C,D,E", text: "Survey conducted with a statistically representative sample of asset users covering summer and winter conditions.", details: [] },
      { id: 2, answer: "D,E", text: "PMV/PPD analysis demonstrates Category B (or better) per ISO 7730 / EN 16798-1.", details: [] },
      { id: 3, answer: "E", text: "Action plan identifies remediation for any space failing Category B and is monitored quarterly.", details: [] },
    ],
    methodology: ["Run seasonal occupant survey; perform PMV/PPD analysis; implement and track actions."],
    evidence: ["Occupant survey results", "PMV/PPD calculations", "Action plan with status"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 14 PDF."],
  },
  {
    code: "Hea 15", category: "Health", title: "Smoking policy", available: 1, part: 2,
    aim: "To protect asset users from exposure to second-hand tobacco and vapour.",
    question: "Is a smoking and vaping policy in place that protects all asset users?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — documented policy banning smoking/vaping inside the asset and within designated exclusion zones outside" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Smoking and vaping prohibited inside the asset and within 5 m of entrances, openable windows and air intakes.", details: [] },
      { id: 2, answer: "C", text: "Designated smoking areas (if provided) are located, signed and managed to prevent re-entry of smoke.", details: [] },
      { id: 3, answer: "C", text: "Policy is communicated to all asset users and reviewed at least every 3 years.", details: [] },
    ],
    methodology: ["Review policy document; site walk to confirm signage and exclusion zones."],
    evidence: ["Smoking & vaping policy", "Signage photographs"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 15 PDF."],
  },
  {
    code: "Hea 16", category: "Health", title: "Indoor air quality plan", available: 2, part: 2,
    aim: "To recognise assets with a structured plan for managing indoor air quality.",
    question: "Is an indoor air quality (IAQ) plan in place covering monitoring, sources, ventilation and response?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "IAQ plan in place" },
      { id: "D", credits: 2, label: "IAQ plan + IAQ measurements within last 3 years against recognised thresholds" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Plan identifies indoor and outdoor pollution sources, ventilation strategy, maintenance and occupant complaint procedure.", details: [] },
      { id: 2, answer: "D", text: "Measurements include CO₂, TVOC, formaldehyde and PM2.5/PM10 in representative spaces, compared against WHO / EN 16798 thresholds.", details: [] },
      { id: 3, answer: "C,D", text: "Plan reviewed at least every 3 years and after any major refurbishment.", details: [] },
    ],
    methodology: ["Engage qualified IAQ consultant; document plan; commission measurements."],
    evidence: ["IAQ plan", "Measurement report with comparison against thresholds"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 16 PDF."],
  },
  {
    code: "Hea 17", category: "Health", title: "Acoustic conditions", available: 2, part: 2,
    aim: "To ensure acoustic conditions support intended use and occupant wellbeing.",
    question: "Have acoustic conditions been assessed and meet relevant national or international standards?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Acoustic survey completed in last 5 years covering indoor ambient noise levels" },
      { id: "D", credits: 2, label: "Survey covers ambient noise, sound insulation and reverberation to relevant standard (e.g. BS 8233, ANSI S12.60)" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Survey conducted by a qualified acoustician.", details: [] },
      { id: 2, answer: "D", text: "Indoor ambient noise meets BS 8233 (or equivalent) for the building type and use class.", details: [] },
      { id: 3, answer: "D", text: "Sound insulation (airborne / impact) and reverberation times measured for representative spaces.", details: [] },
    ],
    methodology: ["Commission acoustic survey; benchmark against standard; implement remediation as needed."],
    evidence: ["Acoustic survey report"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 17 PDF."],
  },
  {
    code: "Hea 18", category: "Health", title: "Legionella risk management", available: 1, part: 2,
    aim: "To minimise risk of Legionellosis from water systems within the asset.",
    question: "Is a documented Legionella risk assessment and management plan in place?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — assessment by competent person and management plan implemented" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Risk assessment carried out by a competent person in accordance with HSE L8 / WHO guidance (or national equivalent) and reviewed at least every 2 years.", details: [] },
      { id: 2, answer: "C", text: "Written scheme of control covers temperature monitoring, flushing of little-used outlets, cleaning of cooling towers / calorifiers and disinfection.", details: [] },
      { id: 3, answer: "C", text: "Records of monitoring, inspection and remedial action retained for at least 5 years.", details: [] },
    ],
    methodology: ["Engage competent Legionella consultant; implement written scheme of control; maintain logs."],
    evidence: ["Legionella risk assessment", "Written scheme of control", "Monitoring logs"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 18 PDF."],
  },
  {
    code: "Hea 19", category: "Health", title: "Drinking water quality testing", available: 1, part: 2,
    aim: "To recognise routine testing of drinking water quality.",
    question: "Is drinking water tested at the outlet for microbiological and chemical quality?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — annual testing against recognised drinking water quality standards with action plan for any failures" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Samples taken from representative drinking water outlets at least annually.", details: [] },
      { id: 2, answer: "C", text: "Testing covers microbiological (total coliforms, E. coli, Legionella where applicable) and chemical (pH, lead, copper) parameters per local drinking water regulation or WHO guidelines.", details: [] },
      { id: 3, answer: "C", text: "Any exceedance triggers documented remedial action and re-test.", details: [] },
    ],
    methodology: ["Engage accredited lab; sample annually; record results and any remediation."],
    evidence: ["Lab certificates", "Sampling schedule and remediation log"],
    notes: ["Summarised from BREEAM In-Use v6 HEA 19 PDF."],
  },
  {
  ...
  {
    code: "Rsl 1", category: "Resilience", title: "Flood risk assessment", available: 2, part: 2,
    aim: "To recognise assets that understand and manage flood risk to ensure operational continuity.",
    question: "Has a current flood risk assessment been completed for the asset?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — assessment covers all relevant flood sources (fluvial, pluvial, groundwater, coastal, sewer) in last 5 years" },
      { id: "D", credits: 2, label: "Yes — assessment + documented flood resilience / mitigation measures implemented" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Flood risk assessment by a competent person, considering present-day and climate-change-adjusted flood return periods.", details: [] },
      { id: 2, answer: "D", text: "Mitigation measures address access/egress, critical plant location, flood barriers / SuDS, and recovery plan.", details: [] },
    ],
    methodology: ["Engage flood risk specialist; review against national flood mapping; implement measures."],
    evidence: ["Flood risk assessment report", "Mitigation plan with action status"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 01 PDF."],
  },
  {
    code: "Rsl 2", category: "Resilience", title: "Surface water management", available: 2, part: 2,
    aim: "To minimise risk and impact of surface water flooding on and from the asset.",
    question: "Are surface water management measures in place to control run-off rates and volumes from the site?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Site achieves run-off rates no worse than greenfield equivalent" },
      { id: "D", credits: 2, label: "Run-off compliance + SuDS providing water quality treatment and biodiversity benefit" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Drainage strategy demonstrates post-development run-off ≤ greenfield rates for 1-in-100-year + climate change event.", details: [] },
      { id: 2, answer: "D", text: "SuDS hierarchy applied (source / site / regional) including at least one quality treatment stage.", details: [] },
    ],
    methodology: ["Drainage / SuDS strategy review by drainage engineer."],
    evidence: ["Drainage strategy report", "SuDS as-built drawings and maintenance plan"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 02 PDF."],
  },
  {
    code: "Rsl 3", category: "Resilience", title: "Natural hazard risk assessment", available: 2, part: 2,
    aim: "To assess and mitigate risks from natural hazards relevant to the asset's location.",
    question: "Has a natural hazard risk assessment been completed and used to inform mitigation measures?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Assessment completed for all relevant natural hazards (seismic, wind, wildfire, landslide, subsidence, etc.)" },
      { id: "D", credits: 2, label: "Assessment + mitigation plan implemented" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Assessment considers location-specific hazards using authoritative national hazard maps.", details: [] },
      { id: 2, answer: "D", text: "Mitigation measures are documented, scheduled and budgeted; residual risks are accepted in writing.", details: [] },
    ],
    methodology: ["Engage geotechnical / structural specialist where relevant; document findings."],
    evidence: ["Natural hazard risk assessment", "Mitigation action plan"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 03 PDF."],
  },
  {
    code: "Rsl 4", category: "Resilience", title: "Resilient design features", available: 2, part: 2,
    aim: "To recognise the implementation of physical features that improve asset resilience to identified hazards.",
    question: "Have resilient design features been incorporated into the asset?",
    instruction: "Select all answers that apply.",
    selectionMode: "multiple",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Critical plant / electrical equipment elevated above design flood level" },
      { id: "D", credits: 1, label: "Façade / opening protection installed for relevant hazard (wind, flood, wildfire)" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Critical M&E plant (generators, switchgear, IT, water pumps) located above design flood level + freeboard.", details: [] },
      { id: 2, answer: "D", text: "Protection products meet recognised standard (e.g. PAS 1188 for flood barriers; relevant wind / fire ratings).", details: [] },
    ],
    methodology: ["Audit critical plant locations and protection features against hazard assessment outputs."],
    evidence: ["Asset register with locations and levels", "Product certificates"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 04 PDF."],
  },
  {
    code: "Rsl 5", category: "Resilience", title: "Alarm and detection systems", available: 1, part: 2,
    aim: "To ensure timely detection of hazards through suitable alarm systems.",
    question: "Are alarm and detection systems installed, tested and linked to a documented response procedure?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — fire, intruder and any hazard-specific alarms tested at required frequency and linked to response plan" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Fire detection and alarm system designed and maintained to local standard (e.g. BS 5839, NFPA 72).", details: [] },
      { id: 2, answer: "C", text: "Hazard-specific alarms (flood, gas, CO, security) in place where relevant to the natural hazard / risk profile.", details: [] },
      { id: 3, answer: "C", text: "Test logs retained for at least 12 months; alarms linked to documented response procedure.", details: [] },
    ],
    methodology: ["Audit alarm coverage and test logs; map to risk assessment."],
    evidence: ["Alarm test logs", "System certification"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 05 PDF."],
  },
  {
    code: "Rsl 6", category: "Resilience", title: "Emergency response plan", available: 2, part: 2,
    aim: "To recognise documented and rehearsed emergency response arrangements.",
    question: "Is a current emergency response and business continuity plan in place and rehearsed?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Plan documented and reviewed in last 12 months" },
      { id: "D", credits: 2, label: "Plan documented, reviewed and rehearsed at least annually with debrief and improvement actions" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Plan covers identified hazards, roles, communications, evacuation/shelter, recovery and supplier dependencies.", details: [] },
      { id: 2, answer: "D", text: "Tabletop or live exercise carried out at least annually with documented lessons learned.", details: [] },
    ],
    methodology: ["Maintain plan in version control; schedule annual exercise."],
    evidence: ["Emergency response plan", "Exercise reports and lessons-learned log"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 06 PDF."],
  },
  {
    code: "Rsl 7", category: "Resilience", title: "Climate change risk assessment", available: 2, part: 2,
    aim: "To assess and adapt to climate change risks relevant to the asset.",
    question: "Has a climate change risk assessment been completed covering relevant timeframes and emissions scenarios?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Assessment completed against ≥ 2 IPCC scenarios for 2050" },
      { id: "D", credits: 2, label: "Assessment + adaptation plan integrated into asset management plan" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Assessment aligned with TCFD / ISSB-style physical risk methodology covering chronic and acute climate hazards.", details: [] },
      { id: 2, answer: "D", text: "Adaptation actions assigned, costed and tracked within the asset's strategic plan.", details: [] },
    ],
    methodology: ["Engage qualified climate risk consultant; integrate findings into asset planning."],
    evidence: ["Climate risk assessment report", "Adaptation plan with status"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 07 PDF."],
  },
  {
    code: "Rsl 8", category: "Resilience", title: "Social risk assessment", available: 1, part: 2,
    aim: "To identify and mitigate social risks that may affect occupant wellbeing and asset operation.",
    question: "Has a social risk assessment been completed and used to inform asset management?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — assessment covers community, occupant and worker risks with mitigation plan" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Assessment considers crime, anti-social behaviour, civil disturbance, supply chain dependence and stakeholder relationships.", details: [] },
      { id: 2, answer: "C", text: "Mitigation actions documented and reviewed at least every 2 years.", details: [] },
    ],
    methodology: ["Stakeholder engagement; review against local context."],
    evidence: ["Social risk assessment report", "Mitigation register"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 08 PDF."],
  },
  {
    code: "Rsl 9", category: "Resilience", title: "Fire risk management", available: 2, part: 2,
    aim: "To recognise proactive fire risk management beyond statutory minimum.",
    question: "Is fire risk managed in accordance with a documented strategy that goes beyond statutory minimum?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Fire risk assessment current and all actions closed out on schedule" },
      { id: "D", credits: 2, label: "Above + active fire suppression covering all relevant areas and tested per manufacturer requirement" },
    ],
    criteria: [
      { id: 1, answer: "C,D", text: "Fire risk assessment by competent person reviewed at least annually or after material change.", details: [] },
      { id: 2, answer: "D", text: "Active suppression (sprinklers, mist, gaseous) provided and tested in accordance with local standard.", details: [] },
    ],
    methodology: ["Engage fire engineer / competent person; maintain action register and test logs."],
    evidence: ["Fire risk assessment", "Suppression system certification and test logs"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 09 PDF."],
  },
  {
    code: "Rsl 10", category: "Resilience", title: "Security risk assessment", available: 1, part: 2,
    aim: "To recognise an asset-specific security risk assessment and mitigation strategy.",
    question: "Has a security risk assessment been carried out by a suitably qualified person and acted upon?",
    instruction: "Select a single answer option.",
    selectionMode: "single",
    answers: [
      { id: "A", credits: 0, label: "Question not answered" },
      { id: "B", credits: 0, label: "No" },
      { id: "C", credits: 1, label: "Yes — assessment completed in last 3 years and mitigation actions implemented" },
    ],
    criteria: [
      { id: 1, answer: "C", text: "Assessment by an accredited security consultant (e.g. CSyP, ASIS PSP) covering physical, procedural and electronic security.", details: [] },
      { id: 2, answer: "C", text: "Mitigation actions are tracked, with residual risks formally accepted by asset owner.", details: [] },
    ],
    methodology: ["Engage qualified security consultant; document recommendations and implementation."],
    evidence: ["Security risk assessment report", "Implementation action plan"],
    notes: ["Summarised from BREEAM In-Use v6 RSL 10 PDF."],
  },
];
